...
def modelo(IMG_SIZE, model_name, metrics):
    ...
    outputs = tf.keras.layers.Dense(2, activation="softmax", kernel_initializer='uniform')(x)
...
def late_fusion(IMG_SIZE, model_name, metrics, pesos1 = None, pesos2=None):
    ...
    crop_OCT = tf.keras.layers.Cropping2D(cropping=((0, 0), (248, 0))) #OCT
    crop_FUNDUS = tf.keras.layers.Cropping2D(cropping=((0, 0), (0, 384))) #FUNDUS
    ...
    input_OCT= tf.keras.Input(shape=(248, 632, 3))
